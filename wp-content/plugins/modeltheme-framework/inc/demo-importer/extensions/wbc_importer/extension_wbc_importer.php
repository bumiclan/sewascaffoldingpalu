        ...
        function add_importer_section() {
            ...
            $server_requirements .= '<div id="info-opt-notice-success" class="hasIcon redux-success   redux-info-field redux-field-info">';
                ...
                $server_requirements .= '<ul>';
                    $server_requirements .= '<li>max_execution_time 500</li>';
                ...
                $server_requirements .= '</ul>';
                $server_requirements .= '<p class="redux-info-desc"><b>Note: </b>Average time for demo import: ~5-8 minutes. If the import takes longer than 8 minutes, simply reload the page and click again to Import Demo. It will continue from the previous state (progress). Usually this is caused by low PHP Configuration Limits from your Hosting. If you need help, please contact us <a href="https://modeltheme.com/support/">via Our Help Desk</a></p>';
    ...
    function wbc_extended_example( $demo_active_import , $demo_directory_path ) {
        ...
        */
        if ( class_exists( 'RevSlider' ) ) {
            $wbc_sliders_array = array(
                'Main Home' => array('construction-slider.zip', 'wega-services.zip'),
                'Home Interior Designing' => array('interior-design.zip'),
                'Solar Photovoltaic Installers' => array('cement-manufacturing-1.zip'),
            );
        ...
        */
        ...
        $wbc_home_pages = array(
            'Main Home'  =>  'Main Home',
            'Home Interior Designing'  =>  'Home Interior Designing',
            'Solar Photovoltaic Installers'  =>  'Home Solar Photovoltaic Installers',
        );
