...
if (is_plugin_active('modeltheme-framework/modeltheme-framework.php') && is_plugin_active('redux-framework/redux-framework.php')){
	class MT_Tweets_Widget extends WP_Widget {
	    ...
	    public function widget( $args, $instance ) {
	        ...
	        $tw_username            = $wega['mt_social_tw'];
	        $consumer_key           = $wega['mt_tw_consumer_key'];
	        $consumer_secret        = $wega['mt_tw_consumer_secret'];
	        $access_token           = $wega['mt_tw_access_token'];
	        $access_token_secret    = $wega['mt_tw_access_token_secret'];
