      ...
      */
      $meta_boxes['testimonials_metaboxs'] = array(
            ...
            'fields'     => array(
                  ...
                  array(
                        'name'    => __( 'Testimonial color', 'modeltheme' ),
                        'desc'    => __( 'Set the color of the testimonial', 'modeltheme' ),
      ...
      $meta_boxes['page_metaboxs'] = array(
            ...
            'fields'     => array(
                  ...
                  */
                  ...
                  array(
                        'name'    => __( 'Header Info color', 'modeltheme' ),
                        'desc'    => __( 'Set the color of the info text(Default: #FFFFFF)', 'modeltheme' ),
                        'id'      => 'mt_header_info_custom_color',
                        'type'    => 'colorpicker',
                        'default' => '#FFFFFF'
                  ),
                  array(
                  ...
                  array(
                        'name'    => __( 'Header "FREE CONSULTATION" button background', 'modeltheme' ),
                        'desc'    => __( 'Set the color of the button(Default: #60d158)', 'modeltheme' ),
                        'id'      => 'mt_button_menu_custom_color',
                        'type'    => 'colorpicker',
                        'default' => ''
                  ),
                  array(
                        'name'    => __( 'Header "FREE CONSULTATION" button background - Hover', 'modeltheme' ),
                        'desc'    => __( 'Set the color of the button(Default: #60d158)', 'modeltheme' ),
                        'id'      => 'mt_button_menu_custom_color_hover',
                        'type'    => 'colorpicker',
                        'default' => ''
                  ),
                  array(
